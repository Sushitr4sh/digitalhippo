...
var t = server_1.initTRPC.context().create(); // Initializes tRPC and creates a router and procedures.
...
exports.publicProcedure = t.procedure; // For endpoints that can be accessed publicly.to call

...
exports.appRouter = (0, trpc_1.router)({
    ...
    getInfiniteProducts: trpc_1.publicProcedure
        ...
        cursor: zod_1.z.number().nullish(), // .nullish mean we don't have to pass it (optional), cursor is the last element that was rendered. So if the user is scrolling to get more products, the cursor will be where we will begin fetching the next page of products for the infinite query.

...
var transporter = nodemailer_1.default.createTransport({
    ...
    secure: true,
    port: 465, // Standard secure port for email
    auth: {
        user: "resend",
...
var getPayloadClient = function () {
    ...
    return __awaiter(void 0, __spreadArray([], args_1, true), void 0, function (_a /* Default value = empty object */) {
        var _b, e_1;
        var _c = _a === void 0 ? {} : _a /* Default value = empty object */, initOptions = _c.initOptions;

        ...
        switch (_c.label) {
            ...
            case 2:
                ...
                purchasedProductFileIds = orders
                    ...
                    .flat();
                return [2 /*return*/, {
                        id: { in: __spreadArray(__spreadArray([], ownProductFileIds, true), purchasedProductFileIds, true) }, // Check if the file that you're requesting in either of these two arrays
                    }];
        }
    });
}); };
exports.ProductFiles = {
    ...
    access: {
        ...
        }, // Once you upload a product file, normal users are not going to be able to change it.
        delete: function (_a) {
            var req = _a.req;
            return req.user.role === "admin";
        }, // They should also not be able to delete the product file once the upload, because imagine you buy a product and later on the owner of that product suddenly deletes the product file. If normal users want to request a deletion, they can do so through admins.
    },
    upload: {

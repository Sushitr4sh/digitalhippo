    ...
    fields: [
        {
            ...
            admin: {
                condition: function () { return false; }, // Hide this field from the admin dashboard
            },
        },
        {
            name: "name",
        ...
        },
        {
            ...
            access: {
                create: function () { return false; }, // No one can change this field even the admin except us through the getPayloadClient code. Good idea to set these access policies to false, because we know we never need/should change them.
